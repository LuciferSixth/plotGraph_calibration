...
df_resampled = df_filtered.set_index('Timestamp').resample('8S').agg({
...
# บันทึกผลลัพธ์
df_resampled.to_csv('every8second_attime.csv', index=False)

# แสดงผลลัพธ์
print("\nAnalysis of PPG Rate every 8 seconds:")
print("\nFirst few records:")
